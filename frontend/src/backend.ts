...
import type { Product as _Product, ProductId as _ProductId, ProductType as _ProductType, ServiceCategory as _ServiceCategory, TarotService as _TarotService, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: ProductId, arg1: string, arg2: string, arg3: string, arg4: ProductType, arg5: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addProduct(arg0, arg1, arg2, arg3, to_candid_ProductType_n8(this._uploadFile, this._downloadFile, arg4), arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addTarotService(arg0: string, arg1: string, arg2: bigint, arg3: ServiceCategory, arg4: boolean, arg5: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addTarotService(arg0, arg1, arg2, to_candid_ServiceCategory_n10(this._uploadFile, this._downloadFile, arg3), arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getNewsletterSignUps(): Promise<Array<NewsletterSignupRecord>> {
        if (this.processError) {
            try {
    ...
    async getProductsByCategory(arg0: ProductType): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductsByCategory(to_candid_ProductType_n8(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProductsByType(arg0: ProductType): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductsByType(to_candid_ProductType_n8(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTarotService(arg0: bigint): Promise<TarotService> {
        if (this.processError) {
            try {
                ...
                return from_candid_TarotService_n20(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getTarotServicesByCategory(arg0: ServiceCategory): Promise<Array<TarotService>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTarotServicesByCategory(to_candid_ServiceCategory_n10(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n19(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async signupNewsletter(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: ProductId, arg1: string, arg2: string, arg3: string, arg4: ProductType, arg5: bigint, arg6: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(arg0, arg1, arg2, arg3, to_candid_ProductType_n8(this._uploadFile, this._downloadFile, arg4), arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTarotService(arg0: bigint, arg1: string, arg2: string, arg3: bigint, arg4: ServiceCategory, arg5: boolean, arg6: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTarotService(arg0, arg1, arg2, arg3, to_candid_ServiceCategory_n10(this._uploadFile, this._downloadFile, arg4), arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ServiceCategory_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ServiceCategory): ServiceCategory {
    return from_candid_variant_n23(_uploadFile, _downloadFile, value);
}
function from_candid_TarotService_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _TarotService): TarotService {
...
function from_candid_record_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        name: value.name,
        description: value.description,
        category: from_candid_ServiceCategory_n22(_uploadFile, _downloadFile, value.category),
        price: value.price,
...
function from_candid_record_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        careerMoneyLife: from_candid_vec_n19(_uploadFile, _downloadFile, value.careerMoneyLife),
        premiumExclusive: from_candid_vec_n19(_uploadFile, _downloadFile, value.premiumExclusive),
        miniReadings: from_candid_vec_n19(_uploadFile, _downloadFile, value.miniReadings),
        deepDetailed: from_candid_vec_n19(_uploadFile, _downloadFile, value.deepDetailed),
        loveRelationship: from_candid_vec_n19(_uploadFile, _downloadFile, value.loveRelationship)
    };
}
...
function from_candid_vec_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_TarotService>): Array<TarotService> {
    return value.map((x)=>from_candid_TarotService_n20(_uploadFile, _downloadFile, x));
}
function to_candid_ProductType_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProductType): _ProductType {
...
function to_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProductType): {
    pendulum: null;
} | {
    bracelet: null;
} | {
